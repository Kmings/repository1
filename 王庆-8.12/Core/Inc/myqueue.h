...
#define IncZDriveRear ((ZDriveSendQueue.Rear + 1) % CAN_QUEUESIZE)
...
extern CAN_SendQueueType CAN1_SendQueue, VESC_SendQueue, ZDriveSendQueue,DM_SendQueue;  // CAN口报文发送队列  其中VESC是通过CAN2发送的
extern MesgControlGrpType CAN1_MesgControlList[CAN1_NodeNumber], CAN2_MesgControlList[CAN2_NodeNumber]; // 报文控制表
